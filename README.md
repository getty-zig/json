...
<p align="center">
  ...
  <a href="https://github.com/getty-zig/json/actions/workflows/ci.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/getty-zig/json/ci.yml?branch=main&style=flat-square" /></a>
